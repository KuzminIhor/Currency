...
namespace CurrencyApp
{
	partial class AddBankCurrency
	{
		...
		private void InitializeComponent()
		{
			...
			// button2
			// 
			this.button2.Location = new System.Drawing.Point(722, 442);
			...
			// textBox1
			// 
			this.textBox1.Location = new System.Drawing.Point(336, 216);
			...
			this.label2.Location = new System.Drawing.Point(333, 66);
			this.label2.Name = "label2";
			this.label2.Size = new System.Drawing.Size(142, 20);
			this.label2.TabIndex = 6;
			this.label2.Text = "Оберіть валюту";
			// 
			// label3
			// 
			...
			this.label3.Text = "Введіть курс";
			// 
			// comboBox1
			// 
			this.comboBox1.FormattingEnabled = true;
			this.comboBox1.Location = new System.Drawing.Point(337, 100);
			...
			this.Name = "AddBankCurrencyForm";
			this.Text = "AddBankCurrencyForm";
